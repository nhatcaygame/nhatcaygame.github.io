/**
 * @package     Warning adblock
 * @version     1.0.0
 * @author      Vu Minh Nhat
 * @link        https://www.facebook.com/taolagin20032
 */

! function () {
    function f() {
        var a = document.createElement("div");
        a.id = "nhatcaygame_adblock";
        a.innerHTML = '<div class="inner"><div class="header"><h2 style="color:#fff;">Đã phát hiện Ad Blocker</h2></div><p>Vui lòng tắt trình chặn quảng cáo của bạn để tiếp tục!</p></div>';
